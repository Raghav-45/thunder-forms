...
export function SiteFooter() {
  return (
    <div className="flex items-center justify-center">
      <footer>
        <div className="flex flex-col px-6 py-10 gap-y-8 items-center justify-center container">
          <div className=" grid grid-cols-12 items-center">
            <div className="flex flex-col gap-5 col-span-7">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                Create dynamic, powerful, and user-friendly forms effortlessly
                with Thunder Forms. Designed to simplify your workflow and
                empower you with advanced features.
              </p>
              ...
              <div className="mt-6 place-items-end space-y-2">
                <div className="flex items-center space-x-3 border rounded-full w-4/5 p-1">
                  <Input
                    ...
                    className="w-full rounded-full !bg-transparent !border-none focus:!border-none focus:!ring-0"
                    required
                  />
                  <Button
                    variant="secondary"
          ...
          <div className="flex justify-between w-full">
            <div className="flex flex-row items-center h-10 space-x-0.5">
              ...
              <Link
                href={siteConfig.links.twitter_personal}
                target="_blank"
                rel="noopener"
            ...
            <p className="text-xs text-muted-foreground inline-flex align-bottom">
              © Thunder Forms
              <Icons.Logo className="h-4 w-4 mx-1" />
