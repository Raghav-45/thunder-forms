...
export function SiteFooter() {
  return (
    <footer>
      <div className="flex flex-col py-10 gap-y-8 items-center justify-center container">
        <div className=" grid grid-cols-12 items-center">
          <div className="flex flex-col gap-5 col-span-7">
            ...
            <p className="text-muted-foreground text-base leading-relaxed">
              ...
              with Thunder Forms. Designed to simplify your workflow and empower
              you with advanced features.
            </p>
