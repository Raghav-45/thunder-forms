...
export async function GET(
  ...
  try {
    // Calculate the date 90 days ago (inclusive of today)
    const ninetyDaysAgo = new Date()
    ninetyDaysAgo.setDate(ninetyDaysAgo.getDate() - 89) // Go back 89 days to include today for a total of 90
    ninetyDaysAgo.setHours(0, 0, 0, 0) // Start of that day
